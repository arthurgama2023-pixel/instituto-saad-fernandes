...
export default function LoginAdmin() {
  ...
  const pode = usuario.trim().length > 0 && senha.length > 0;
      ...
      <main className="w-full max-w-[440px] mx-auto min-h-screen flex flex-col">
        ...
        <form onSubmit={entrar} className="flex-1 flex flex-col px-6">
          <div className="flex flex-col items-center text-center mt-6 mb-8">
            ...
            <h1 className="text-headline-lg font-headline-lg text-primary mb-2">Acesso restrito</h1>
            <p className="text-body-md font-body-md text-on-surface-variant max-w-[300px]">
              Entre com as credenciais de administrador para gerenciar médicos e a operação.
            </p>
          </div>
